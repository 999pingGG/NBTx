 ...
 */
nbtx_status nbt_dump_file(const nbtx_node* tree,
 ...
 */
nbtx_node* nbt_filter_inplace(nbtx_node* tree, nbtx_predicate_t, void* aux);
 ...
 */
nbtx_node* nbt_find(nbtx_node* tree, nbtx_predicate_t, void* aux);
 ...
 * Feel free to cast as necessary.
 */
nbtx_node* nbt_find_by_name(nbtx_node* tree, const char* name);
 ...
 */
nbtx_node* nbt_find_by_path(nbtx_node* tree, const char* path);
 ...
 */
nbtx_node* nbt_list_item(nbtx_node* list, int n);
...
bool nbt_eq(const nbtx_node* restrict a, const nbtx_node* restrict b);
 ...
 * allocated, and therefore does not have to be freed by the user.
 */
const char* nbt_error_to_string(nbtx_status);
